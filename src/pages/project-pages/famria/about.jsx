        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="text-base leading-relaxed">
              The Farm to Market Road Impact Assessment (FaMRIA) Project is a comprehensive
              evaluation aimed at analyzing the effects and outcomes of implementing Farm-to-Market
              Roads (FMRs) in rural areas. This project involves a structured methodology to assess
              the impact of these roads on various socio-economic factors, agricultural
