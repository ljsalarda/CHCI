        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="text-base leading-relaxed text-muted-foreground">
              ...
              industries already employ these concepts to optimize their processes through embedded
              sensors, automation, and robotization. However, the delivery of training and
              instruction for mining education has largely remained traditional. The Industry 4.0
              Learning Factory bridges this gap through a Digital Training Center making use of
              Virtual Reality (VR) and Augmented Reality (AR). It envisions an augmented miner with
              senses and memory extended through technology.
            </p>
